...
```
gfortran -std=f2018 -Ibuild/mod -o build/async_geometry_pipeline_demo \
  examples/async_geometry_pipeline_demo.f90 build/libglamin.a
...
See `examples/pipeline_callbacks_demo.c` for a minimal registration stub.
